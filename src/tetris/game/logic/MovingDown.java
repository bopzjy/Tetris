...
public class MovingDown implements Runnable {
	...
	public void checkFullRow(FallingEntity fEntity) {
		...
		// int[] rowIndex = { fEntity.headSpot.x, fEntity.secSpot.x,
		// fEntity.thirdSpot.x, fEntity.fourthSpot.x };
	...
	// }
	//
	// int rowNum = rowIndex[GameConstants.NUMBER_OF_SPOT - 1] - rowIndex[0] +
	// 1;
